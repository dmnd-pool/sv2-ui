...
const infra = new pulumi.StackReference('dmnd-tech-org/dmnd-cloud/staging');
const env = 'staging';
const appName = 'user-dash-fe';

const vpcId = infra.requireOutput('vpc').apply(vpc => vpc['vpcId']);

// const privateSubnetIds = infra
//   .requireOutput('vpc')
//   .apply(vpc => vpc['privateSubnetIds']);
