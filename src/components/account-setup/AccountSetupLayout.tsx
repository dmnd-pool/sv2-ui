...
export type AccountSetupStep = 'twofa' | 'bitcoin' | 'connect' | 'done';

type GateStep = Exclude<AccountSetupStep, 'done'>;
...
function stateFor(stepKey: GateStep, current: AccountSetupStep): NodeState {
...
function Stepper({ current, orientation }: { current: AccountSetupStep; orientation: 'vertical' | 'horizontal' }) {
