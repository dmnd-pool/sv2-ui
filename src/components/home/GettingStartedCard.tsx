 ...
 * progress bar; account items link into the onboarding flow and the card hides
...
export function GettingStartedCard({ from, to }: { from: string; to: string }) {
  ...
  const items = [
    ...
    { label: 'Setup 2FA', done: account != null && account.two_factor_secret === null, href: '/onboarding' },
    { label: 'Add payout address', done: hasBitcoinAddress(account), href: '/onboarding' },
  ];
